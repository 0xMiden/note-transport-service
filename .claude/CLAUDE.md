...
> Per-project lessons: ~/.claude/projects/note-transport/lessons.md
...
- **Branch naming:** Always prefix branch names with `<author>-claude/` (e.g. `dominik1999-claude/fix-foo`)
